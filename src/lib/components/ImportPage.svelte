<script lang="ts">
  ...
  import { BinanceLiveSource, CoinmateLiveSource, RevolutXLiveSource } from '$lib/sources';
  ...
  const liveSources = [new BinanceLiveSource(), new RevolutXLiveSource(), new CoinmateLiveSource()];
